...
const testimonials = [
  ...
  },
  {
    ...
    text: "We needed a mobile app that felt organic and calm. Emeka nailed the aesthetic immediately. The development handoff was flawless.",
  ...
  },
  {
    ...
    text: "Fast, communicative, and technically literate. He understands the constraints of code, which makes the design process so much smoother.",
  ...
  },
  {
    ...
    text: "The rebranding project exceeded our expectations. Our conversion rates increased by 40% within the first month of the new site launch.",
