...
const plans = [
  {
    ...
    features: ["UI/UX Design", "Figma Source Files", "Interactive Prototype", "2 Revisions", "Design System"],
    theme: "orange",
    popular: false,
  },
  {
    ...
    features: ["Next.js & React", "Supabase Integration", "Responsive & Mobile First", "SEO Optimization", "1 Month Support"],
    theme: "emerald",
  ...
  },
  {
    ...
    features: ["Everything in Design & Dev", "Backend Architecture", "Payment Integration", "Analytics Setup", "3 Months Support"],
    theme: "blue",
    popular: false,
  },
];
      ...
      <main className="pt-32 pb-20 px-6 md:px-12 mx-auto w-full flex-grow">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            >
                <motion.div 
                    ...
                    className={`w-6 h-6 rounded-full bg-white shadow-sm ${billingCycle === 'monthly' ? 'ml-0' : 'ml-8'}`}
                />
            </button>

            <span className={`text-sm font-bold ${billingCycle === 'yearly' ? 'text-black' : 'text-gray-400'}`}>
                Yearly <span className="text-orange-500 text-xs ml-1">(Save 20%)</span>
            </span>
          </div>
        </div>
            ...
            >
              ...
              */}
              ...
              <div className={`
                ...
                ${plan.popular ? 'bg-black text-white border-transparent' : 'bg-white text-gray-900 border-gray-100 hover:border-gray-200 hover:shadow-xl'}
              `}>
                ...
                <div>
                    ...
                    <p className={`text-sm mb-8 leading-relaxed ${plan.popular ? 'text-gray-400' : 'text-gray-500'}`}>
                        {plan.description}
                    </p>
                    ...
                    <div className="mb-8 flex items-baseline gap-1">
                        ...
                        <span className={`text-sm font-medium ${plan.popular ? 'text-gray-500' : 'text-gray-400'}`}>/mo</span>
                    </div>
                    ...
                    <ul className="space-y-4 mb-10">
                        {plan.features.map((feature, i) => (
                            <li key={i} className="flex items-center gap-3">
                                <Check size={18} className={plan.popular ? 'text-emerald-400' : `text-${plan.theme}-500`} />
        ...
        <div className="mt-32 max-w-3xl mx-auto border-t border-gray-100 pt-20">
            ...
            <div className="space-y-8">
                {[
                    { q: "Can I pause my subscription?", a: "Yes, you can pause your development subscription at any time and resume when you have new tasks." },
                    { q: "What is your turnaround time?", a: "Most design requests are completed within 2 days. Development tasks typically take 3-5 business days." },
                    { q: "Do you offer refunds?", a: "Due to the high quality nature of the work, refunds are not issued once work has commenced." }
                ].map((item, i) => (
