...
import { ArrowDownRight, MoveRight, User } from "lucide-react";
      ...
      <main className="pt-32 pb-20 px-6 md:px-8 mx-auto w-full grow flex flex-col justify-between max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-12 mb-20 md:mb-32">
          ...
          >
            ...
            {/* Placeholder Icon/Text (Visible if Image is commented out) */}
            <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-300 transition-colors group-hover:text-gray-400 z-10">
